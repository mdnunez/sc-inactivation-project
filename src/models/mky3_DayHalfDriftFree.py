...
#                            Model with all variables free across days, only modeling rightwardRT,  and drift free across sessions
#
...
# ====         ================                       ======================
# 02/20/20      Michael Nunez          Converted from mky3_PrePostRecHalf.py
...
model {
    ...
    for (i in 1:N) {
        ...
        ld_comp2[i, 1] <- dlogwiener(rightwardRT[i], alpha[day[i]], ter[day[i]], beta[day[i]], deltaright[session[i],condition[i]])
